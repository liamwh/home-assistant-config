...
```
start_tv_spotfy:
  module: start_tv_spotfy
  class: StartTvSpotify
  speaker: media_player.kef_ls50
  source: Wifi
  volume: 0.3
  input_boolean: input_boolean.start_tv_spotfy
```
...
DEFAULT_SPEAKER = "media_player.tv"
DEFAULT_SOURCE = "\U0001F4F1 Spotify"
DEFAULT_VOLUME = 0.3
DEFAULT_INPUT_BOOLEAN = "input_boolean.start_tv_spotfy"
...
class StartTvSpotify(hass.Hass):
    def initialize(self):
        self.input_boolean = self.args.get(
            "input_boolean", DEFAULT_INPUT_BOOLEAN)
        self.listen_state(self.start_cb, self.input_boolean,
                          new="on", immediate=True)
